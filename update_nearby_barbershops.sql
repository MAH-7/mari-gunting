-- Migration: Update get_nearby_barbershops to support pagination
-- Step 1: Drop old function (3 parameters)
DROP FUNCTION IF EXISTS public.get_nearby_barbershops(double precision, double precision, double precision);

-- Step 2: Create new function (5 parameters with pagination)
