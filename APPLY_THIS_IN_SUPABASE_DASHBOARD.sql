-- ⚠️ URGENT: Apply this in Supabase Dashboard SQL Editor
-- Dashboard → SQL Editor → New Query → Paste this → Run

-- Drop ALL existing versions of create_booking function
DROP FUNCTION IF EXISTS create_booking(UUID, UUID, JSONB, DATE, TIME, TEXT, UUID, JSONB, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS create_booking(UUID, UUID, JSONB, DATE, TIME, TEXT, UUID, JSONB, TEXT, TEXT, NUMERIC, NUMERIC) CASCADE;
DROP FUNCTION IF EXISTS create_booking(UUID, UUID, JSONB, DATE, TIME, TEXT, UUID, JSONB, TEXT, TEXT, NUMERIC) CASCADE;
DROP FUNCTION IF EXISTS create_booking(UUID, UUID, JSONB, DATE, TIME, TEXT, UUID, JSONB, TEXT, TEXT) CASCADE;
DROP FUNCTION IF EXISTS create_booking(UUID, UUID, JSONB, TIMESTAMPTZ, TEXT, UUID, JSONB, TEXT, TEXT, NUMERIC, NUMERIC, TEXT, TEXT) CASCADE;

-- Create new function with ISO timestamp parameter
...
-- Now test by creating a booking from the Customer app.
